resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.sivakumar.cloud
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.sivakumar.cloud
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.sivakumar.cloud
      type    = "A"
